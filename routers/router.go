...
func init() {
	...
	//机器管理
	beego.Router("/machine/manage", &machines.ManageMachineController{})
	beego.Router("/machine/edit/:id", &machines.EditMachineController{})
	beego.Router("machine/add", &machines.AddMachineController{})
	beego.Router("machine/addmore", &machines.AddMoreMachineController{})
	beego.Router("/machine/ajax/delete", &machines.AjaxMachineDeleteController{})
