                  ...
                  <ul class="list-unstyled">
                    ...
                    <li data-pmodel="审批管理-approval-suitcase||#" class="border">
                      ...
                      <ul class="list-unstyled">
                        ...
                        <li>
                          <div class="form-group" data-cmodel="机器-machine-manage"> 机器：
                            <label class="checkbox-inline">
                              <input type="checkbox" name="permission[]" value="machine-manage">
                              机器列表 </label>
                            <label class="checkbox-inline">
                              <input type="checkbox" name="permission[]" value="machine-add">
                              添加机器 </label>
                            <label class="checkbox-inline">
                              <input type="checkbox" name="permission[]" value="machine-edit">
                              更新机器 </label>
                          </div>
                        </li>
                      </ul>
